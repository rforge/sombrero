# Self-Organizing Maps with ```stochSOM```
...
objects, you have to load the package ```stochSOM```.
...
The initGrid function initializes a new myGrid object. It has two parameters:
...
```{r}
my.first.grid <- initGrid(dimension=c(5,6), topo="square")
```
